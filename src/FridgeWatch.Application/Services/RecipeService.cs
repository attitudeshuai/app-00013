...
public class RecipeService : IRecipeService
{
    ...
    {
        var recipe = await _unitOfWork.Recipes.GetWithIngredientsAsync(id).ThrowIfNullAsync("食谱不存在");
    ...
    {
        await _unitOfWork.Recipes.GetByIdAsync(id).ThrowIfNullAsync("食谱不存在");
